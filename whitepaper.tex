...
Furthermore, the results of analyses are rarely made available to the public or health bodies until after publication, which may be too late to effect change in policy or understanding.
...
Sampling bias can obscure transmission links, and in certain cases we have chosen not to display the inferred states.
...
Despite no known cases of human to human transmission, the high mortality rate of $~30\%$ \citep{li2014epidemiology} makes the threat of mutations which facilitate human to human transmission of extreme concern (see \citep{devries2017three}).
