...
Maximum likelihood ancestral state reconstruction of discrete traits such as country or region of isolation allows identification of probable transmission events given the sampled data, together with inferred probability distribution of ancestral state at each node.
Internal node colours indicate ancestral state and shifts in ancestral state are drawn as links between demes on the map.
